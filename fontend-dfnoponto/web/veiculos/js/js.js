...
var WEB_SERVICE_PROTOCOL = 'http://';
var WEB_SERVICE_SERVER = 'localhost:9999';
var WEB_SERVICE_POSITIONS_URL_PIRACICABANA = '/ITS-infoexport/api/Data/VeiculosGTFS';
var WEB_SERVICE_POSITIONS_URL_MARECHAL = '/ITS-infoexport/api/Data/VeiculosGTFS';
...
var AGENCY_TCB = 'TCB';
var AGENCY_ARRAY = ['AGENCY_PIRACICABANA', 'AGENCY_MARECHAL', 'AGENCY_PIONEIRA', 'AGENCY_SAO_JOSE', 'AGENCY_URBI', 'TCB'];
...
var map = {
    ...
    _createMap: function(divMap) {
        ...
        var mapLayer = L.tileLayer('https://localhost:9999/tiles/{s}/{z}/{x}/{y}.png');
        ...
        parseCars: function(data) {
            ...
            function parse(data) {
                var parseFuntion = function(obj) {
                    ...
                    } else if (data.operadora.nome.indexOf('TCB') != -1) {
                        car.agency = AGENCY_TCB;
...
function updateQuantitativos(cars) {
    ...
    $('#info_TCB').text((countTCB > 100 ? 100 : countTCB) + ' / ' + '100');
}
