...
var map = {
	...
	_filter: function() {
		...
		if (this.filteredLinha) {
			this.cars = this.cars.filter(function(c) { return c.line && c.line == self.filteredLinha; });
		}
...
function updateQuantitativos(cars) {
	...
	$('.agency_card_container').show();
	$('.filtro_linha_container').show();
	$('#info_total').text('Total: ' + totalRunning + ' / ' + total);
	$('#info_piracicabana').text(countRunningPiracicabana + ' / ' + countPiracicabana);
	$('#info_marechal').text(countRunningMarechal + ' / ' + countMarechal);
	$('#info_pioneira').text(countRunningPioneira + ' / ' + countPioneira);
	$('#info_sao_jose').text( countRunningSaoJose + ' / ' + countSaoJose);
	$('#info_urbi').text(countRunningUrbi + ' / ' + countUrbi);
}
